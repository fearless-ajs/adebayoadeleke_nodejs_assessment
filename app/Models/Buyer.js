...
const buyerSchema = new mongoose.Schema({
    ...
    name:{
        type: String,
        unique: [true, 'The buyer name exists, please choose another name'],
        required: [true, 'Please supply your buyer Name'],
        trim: true,
        maxlength: [40, 'The buyer Name must not have than 40 characters'],
        minlength: [2, 'The buyer Name must have more than 2 characters']
    },
    slug: String,
    phone: {
        type: String,
